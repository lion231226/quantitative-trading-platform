...
// 获取策略类型配置
export const getStrategyConfig = (strategyType: StrategyType): StrategyTypeConfig | undefined => {
...
export const STRATEGY_STATUS_LABELS = {
  'available': { text: '可用', color: 'bg-green-100 text-green-800', borderColor: 'border-green-200' },
  'coming-soon': { text: '即将推出', color: 'bg-blue-100 text-blue-800', borderColor: 'border-blue-200' },
  'experimental': { text: '实验性', color: 'bg-orange-100 text-orange-800', borderColor: 'border-orange-200' }
}
