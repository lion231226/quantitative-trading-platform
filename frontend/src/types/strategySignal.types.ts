...
export type SignalEvent =
  ...
  | {
      type: 'SIGNAL_UPDATED';
      payload: { oldSignal: StrategySignal; newSignal: StrategySignal };
    }
  | {
  ...
  | {
      ...
      payload: { signals: StrategySignal[]; filter: SignalFilter };
    }
  | {
      type: 'CACHE_UPDATED';
      payload: { key: string; signals: StrategySignal[] };
    };
