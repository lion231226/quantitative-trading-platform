...
const TestComponent: React.FC = () => {
  ...
  return (
    <div>
      ...
      <div data-testid="colorblind-enabled">
        {colorblindConfig.enabled.toString()}
      </div>
      <button
...
describe('Theme System', () => {
  ...
  describe('ThemeProvider', () => {
    it('应该提供默认主题状态', () => {
      ...
      expect(screen.getByTestId('colorblind-enabled')).toHaveTextContent(
        'false',
      );
    });
    ...
    it('应该能够切换市场模式', async () => {
      ...
      await waitFor(
        () => {
          expect(screen.getByTestId('market-mode')).toHaveTextContent(
            'international',
          );
        },
        { timeout: 1000 },
