...
import { CandlestickData, TimePeriod } from '../../../types/kline.types';
...
describe('KlineChartContainer', () => {
  ...
  test('displays optimization information when data is sampled', () => {
    ...
    render(
      <KlineChartContainer
        ...
        config={{
          performance: { enableDataSampling: true, maxDataPoints: 1000 },
        }}
      />,
    );
  ...
  test('applies custom className', () => {
    ...
    render(<KlineChartContainer {...defaultProps} className={customClass} />);
  ...
  test('handles empty data gracefully', () => {
    render(<KlineChartContainer data={{ candlesticks: [], signals: [] }} />);
  ...
  test('handles chart ready callback', () => {
    ...
    render(
      <KlineChartContainer {...defaultProps} onChartReady={onChartReady} />,
    );
