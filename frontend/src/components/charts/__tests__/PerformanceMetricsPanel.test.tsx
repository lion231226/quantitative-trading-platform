...
describe('PerformanceMetricsPanel', () => {
  ...
  const renderWithTheme = (component: React.ReactElement) => {
    return render(
      <ThemeProvider defaultTheme="test-light">{component}</ThemeProvider>,
    );
  };

  test('应该在无数据时显示占位信息', () => {
    renderWithTheme(<PerformanceMetricsPanel metricsData={[]} />);
  ...
  test('应该显示主要性能指标（紧凑模式）', () => {
    renderWithTheme(
      <PerformanceMetricsPanel metricsData={mockMetricsData} compact={true} />,
    );
  ...
  test('应该在有多个曲线时显示对比分析', () => {
    renderWithTheme(
      <PerformanceMetricsPanel metricsData={mockMetricsData} compact={false} />,
    );
